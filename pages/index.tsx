          ...
          <div className="flex flex-col-reverse sm:flex-row items-start">
            <div className="flex flex-col pr-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-16">
                Fiddling with the building blocks of AI. Trying to do my little
                part in the quest of the Ultimate Question. I am always looking
                for the spirit of an engineer in a kind heart.
              </p>
            </div>
